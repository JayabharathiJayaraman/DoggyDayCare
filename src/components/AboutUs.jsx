...
const AboutUs = () => {
    ...
    return (
        ...
        <div>
        <div className = 'aboutUsDogImg'>
        <img className = 'aboutUsDogImg'src={dog}/>
        </div>
        <div className = 'row'>
        ...
        <h1 className = 'h1'>Your dog daycare in Järvastaden</h1>
